                        ...
                        <div className="menu-list-row">
                            <div className="row g-xxl-5 bydefault_show" id="menu-dish">
                                ...
                                <div className="col-lg-4 col-sm-6 dish-box-wp lunch" data-cat="lunch">
                                    <div className="dish-box text-center">
                                        <div className="dist-img">
                                            <img src="/images/dish/burger-3.png" alt="" />
                                        </div>
                                ...
                                <div className="col-lg-4 col-sm-6 dish-box-wp dinner" data-cat="dinner">
                                    <div className="dish-box text-center">
                                        <div className="dist-img">
                                            <img src="/images/dish/burger-5.png" alt="" />
                                        </div>
                                ...
                                <div className="col-lg-4 col-sm-6 dish-box-wp dinner" data-cat="dinner">
                                    <div className="dish-box text-center">
                                        <div className="dist-img">
                                            <img src="/images/dish/burger-4.png" alt="" />
                                        </div>
                    ...
                    <div className='col-md-8'>
                        <div className="banner">
                            ...
                            <div className='discount'>
                                <img src='/images/food-img-1.png' className=' discount-img' />
                            </div>
                        ...
                        <div className='row flex-column'>
                            <div className="col-md-12">
                                <div className="banner">
                                    ...
                                    <div className='discount'>
                                        <img src='/images/food-img-2.png' className=' discount-img' />
                                    </div>
                            ...
                            <div className="col-md-12">
                                <div className="banner">
                                    ...
                                    <div className='discount'>
                                        <img src='/images/food-img-3.png' className=' discount-img' />
                                    </div>
